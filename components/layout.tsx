...
export const siteTitle = 'Harry Potter | Renounced ';
  ...
  return (
    <div className="App">
      <Head>
        ...
        <meta
          name="description"
          content="Jump into the fun-filled world of $HARRYPOTTER and awaken the playful and adventurous spirit of Harry Potter."
        />
        <meta
          property="og:image"
          content={`images/didi-share.webp`}
        />
        <meta
          name="og:title"
          content={siteTitle}
          ...
          <div className="Header">
            <div className="Header-Left">
              <a
                ...
                href="https://harrypotter.finance">
      ...
      <footer>
        ...
        <div className="App-Container">
          <div className="Section-Content">
            ...
            <h3>Unleash Harry Potter, his time is here!</h3>
